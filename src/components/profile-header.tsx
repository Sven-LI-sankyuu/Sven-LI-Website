...
export function ProfileHeader({ locale }: { locale: Locale }) {
  ...
  return (
    <section className="screen-line-bottom relative isolate grid grid-cols-1 overflow-hidden border-x border-line bg-background/95 sm:grid-cols-[minmax(0,1.15fr)_16rem]">
      ...
      />
      <div className="relative z-10 min-h-64 overflow-hidden border-b border-line p-4 sm:col-start-2 sm:min-h-80 sm:border-b-0 sm:border-l">
      ...
      <div className="relative z-10 min-w-0 border-b border-line px-4 py-3 sm:col-start-1 sm:border-b-0 sm:border-r">
